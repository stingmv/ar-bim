...
public class FusionStats : Fusion.Behaviour {
  ...
  [SerializeField] [HideInInspector] Text _titleText;

  [SerializeField] [HideInInspector] Text _clearIcon;
  [SerializeField] [HideInInspector] Text _pauseIcon;
  [SerializeField] [HideInInspector] Text _togglIcon;
  [SerializeField] [HideInInspector] Text _closeIcon;
  [SerializeField] [HideInInspector] Text _canvsIcon;

  [SerializeField] [HideInInspector] Text _clearLabel;
  [SerializeField] [HideInInspector] Text _pauseLabel;
  [SerializeField] [HideInInspector] Text _togglLabel;
  [SerializeField] [HideInInspector] Text _closeLabel;
  [SerializeField] [HideInInspector] Text _canvsLabel;
  [SerializeField] [HideInInspector] Text _objectNameText;

  [SerializeField] [HideInInspector] GridLayoutGroup _graphGridLayoutGroup;
  ...
  [SerializeField] [HideInInspector] Button _titleButton;
  [SerializeField] [HideInInspector] Button _objctButton;
  [SerializeField] [HideInInspector] Button _clearButton;
  [SerializeField] [HideInInspector] Button _togglButton;
  [SerializeField] [HideInInspector] Button _pauseButton;
  [SerializeField] [HideInInspector] Button _closeButton;
  [SerializeField] [HideInInspector] Button _canvsButton;
