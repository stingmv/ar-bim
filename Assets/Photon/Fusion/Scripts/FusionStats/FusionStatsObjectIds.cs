...
public class FusionStatsObjectIds : Fusion.Behaviour, IFusionStatsView {
  ...
  [SerializeField] [HideInInspector] Text _inputValueText;
  [SerializeField] [HideInInspector] Text _stateValueText;
  [SerializeField] [HideInInspector] Text _objectIdLabel;

  [SerializeField] [HideInInspector] Image _stateAuthBackImage;
  [SerializeField] [HideInInspector] Image _inputAuthBackImage;
  ...
  RectTransform AddAuthorityPanel(RectTransform parent, string label, ref Text valueText, ref Image backImage) {
    var fontColor = _fusionStats.FontColor;
