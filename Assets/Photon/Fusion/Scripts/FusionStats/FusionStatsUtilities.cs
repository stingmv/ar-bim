...
namespace Fusion.StatsInternal {
  ...
  public static class FusionStatsUtilities {
    ...
    public static Dropdown CreateDropdown(this RectTransform rt, float padding, Color fontColor) {
      ...
      var dropdown = dropRT.gameObject.AddComponent<Dropdown>();
      ...
      var toggle = itemRT.gameObject.AddComponent<Toggle>();
      ...
      var itemBack = itemBackRT.gameObject.AddComponent<Image>();

      var itemChckRT = itemRT.CreateRectTransform("Item Checkmark", true)
        .SetAnchors(0.05f, 0.1f, 0.1f, 0.9f)
        .SetOffsets(0, 0, 0, 0);

      var check = itemChckRT.gameObject.AddComponent<Image>();
    ...
    internal static RectTransform MakeGuides(this RectTransform parent) {
      ...
      top.gameObject.AddComponent<Image>().color = outlineColor;
      ...
      bottom.gameObject.AddComponent<Image>().color = outlineColor;
